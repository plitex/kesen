...
const hasOwn = (obj: any, prop: any) => ({}.hasOwnProperty.call(obj, prop));
 ...
 */
EJSON.addType = (name: string, factory: any) => {
...
const builtinConverters: any = [
  {
    // Date
    matchJSONValue(obj: any) {
    ...
    matchObject(obj: any) {
      ...
      if (obj) {
        ...
        if (keyCount === 1 || keyCount === 2) {
          match = builtinConverters.some((converter: any) => converter.matchJSONValue(obj));
        }
      }
      return match;
    },
...
const adjustTypesToJSONValue = (obj: any) => {
...
const adjustTypesFromJSONValue = (obj: any) => {
  if (obj === null) {
    return null;
  }
 ...
 */
EJSON.stringify = (item: any, options: any) => {
  let serialized;
 ...
 * default is `false`.
 */
EJSON.equals = (a: any, b: any, options: any) => {
  let i: any;
